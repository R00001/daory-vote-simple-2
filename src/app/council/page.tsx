  ...
  if (eligibility && !eligibility.eligible) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-24 text-center">
        ...
        <a href="/council/results" className="inline-block mt-6 px-6 py-2.5 border border-daory-border text-white text-sm font-medium hover:border-daory-cyan transition-colors uppercase tracking-wider">
          View Results
        </a>
      </div>
    );
